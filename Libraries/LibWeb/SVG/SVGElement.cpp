...
String SVGElement::get_an_elements_target(Optional<String> target) const
{
...
Web::HTML::TokenizedFeature::NoOpener SVGElement::get_an_elements_noopener(URL::URL const& url, StringView target) const
{
